<template>
	<el-container>
		...
		<el-main class="nopadding">
			<hlTable ref="table" :apiObj="apiObj" row-key="id" @selection-change="selectionChange" hidePagination>
	...
	export default {
		...
		methods: {
			...
			async table_del(row){
				...
				var res = await this.$API.dept.post(reqData);
				if(res.code == 200){
