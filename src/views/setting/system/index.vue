		...
		<el-card shadow="never">
			<el-tabs tab-position="top">
				...
				<el-tab-pane label="系统设置">
					<el-form ref="form" :model="sys" label-width="100px" style="margin-top: 20px;">
						...
						<el-form-item label="登录开关">
							...
							<div class="el-form-item-msg" data-v-b33b3cf8="">关闭后普通员工无法登录，仅允许管理员角色登录</div>
						</el-form-item>
				...
				<el-tab-pane label="短信配置">
					<el-form ref="form" :model="msg" label-width="100px" style="margin-top: 20px;">
						<el-form-item label="短信开关">
							...
							<div class="el-form-item-msg" data-v-b33b3cf8="">关闭后员工无法收到短信，但日志中将记录</div>
						</el-form-item>
				...
				<el-tab-pane label="扩展配置">
					<el-alert title="扩展配置为系统业务所有的配置，应该由系统管理员操作，如需员工配置应另起业务配置页面。" type="warning" style="margin-bottom: 15px;"></el-alert>
