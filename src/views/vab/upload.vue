		...
		data() {
			return {
				...
				fileurlArr: [
					{
						name: '销售合同模板.xlsx',
						url: 'http://www.HUALAadmin.com/files/220000198611262243.xlsx'
					},
					{
						name: '企业员工联系方式.xlsx',
						url: 'http://www.HUALAadmin.com/files/350000201004261875.xlsx',
					}
				],
				fileurl: "http://www.HUALAadmin.com/files/220000198611262243.xlsx,http://www.HUALAadmin.com/files/350000201004261875.xlsx",
